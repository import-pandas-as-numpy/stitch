...
This file records local performance checks. Treat these as development notes,
not broad benchmark claims.
...
### Local Fixture Timing

Use the checked-in local harness for repeatable fixture timing:
...
Record Rayon timing checks here with:
