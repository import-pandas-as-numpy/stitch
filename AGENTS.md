...
The project log should live under `/docs`. If no more specific file exists, create or update `/docs/project-log.md`.
...
3. Update documentation and project log when behavior or project status changes.
